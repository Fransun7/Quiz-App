document.addEventListener("DOMContentLoaded", () => {
  ...
  const showPref = document.getElementById("show-pref");
  ...
  /*
  showPref.addEventListener("click", showAnswer);
  ...
  */
  ...
  function showChoices() {
    ...
    currentChoices.choices.forEach((choice) => {
      ...
      if (currentIndex === 0) {
        nextButton.classList.add("next-btn-first-appearance");
      }
  ...
  /* function scoreCal(clickedChoice) {
  ...
  function showAnswer() {
    ...
    text.textContent(myCorrectAnswers);
